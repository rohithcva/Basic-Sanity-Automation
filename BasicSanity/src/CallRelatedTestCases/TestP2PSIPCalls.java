...
public class TestP2PSIPCalls 
{
	...
	public static void main(String s[]) throws Exception 
	{
		...
		LogRegister.logger.info("TestP2PSIP :main()");
	  ...
	  /*  if(Mname.contains("6000")){
	   ...
	   for(int i=0;i<len;i++)
	   {
		   ...
		   System.out.println("--------------------------------------------------");
		   // 1= SIP   2= H323     3= ISDN
		   System.out.println(sut1+" "+sip1);
		   c.PlaceaCall(sut1,sip2,driver,element,1,c1);
		   Thread.sleep (10000);
