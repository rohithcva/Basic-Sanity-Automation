...
public class TestP2PH320Calls 
{
 		public static void main(String s[]) throws Exception 
		{
			...
			LogRegister.logger.info("TestP2PH320Calls :main()");
		...
		int CallDelay= (int) (Float.parseFloat(Calldelay)*60000);
		int ContentDelay= (int) (Float.parseFloat(Contentdelay)*60000);
		int TCDelay= (int) (Float.parseFloat(TCdelay)*60000);
	    ...
	    System.setProperty("webdriver.chrome.driver",path);
		  ...
		  // testname1 = testname1.concat(str);
		   ...
		   System.out.println("--------------------------------------------------");
		   // 1= SIP   2= H323     3= ISDN
		   c.PlaceaCall(sut1,isdn1,driver,element,3,c1);
		   Thread.sleep (10000);
