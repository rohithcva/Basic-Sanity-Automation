...
public class TestMixedMPCalls 
{
	public static void main(String s[]) throws Exception 
	{
		...
		LogRegister.logger.info("TestMixesMPCalls : main()");
        ...
        System.out.println(sut1+" "+sut2+" "+sut3);
        String mmptestname1="Basic Sanity: Beta Smoke-Mixed MP H323 & SIP call ";
        String mmptestinfo1="Call type-H323 & SIP ";

        System.out.println("\n"+mmptestname1);	
        System.out.println("--------------------------------------------------");
        c.mixmpPlaceaCall(sut1,sip1,sut2,driver,element,2);
        boolean mfc=c.hangupcheck(driver, element),msc=c.mphangupcheck(driver, element);
        if(mfc && msc)
        {
        	callspeedcheck=true;
        ...
        o.writecsv(Info,mmptestname1,mmptestinfo1,callstatus,vgacontentstatus,ppcipcontentstatus,callspeedcheck);   
        driver.close();
        LogRegister.logger.info("Exiting TestMixedMPCalls:main()");
        System.exit(0);
	} 
