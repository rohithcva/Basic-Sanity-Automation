...
public class TestMPH323Calls 
{
 		public static void main(String s[]) throws Exception 
 		{
			...
			LogRegister.logger.info("TestMPH323Calls :main()");
		  ...
		  LogRegister.logger.info("Exiting TestMPH323Calls : main()");
		   ...
		   // 1= SIP   2= H323     3= ISDN
		    ...
		    System.out.println("\n"+mptestname1);
		    System.out.println("--------------------------------------------------");
		      c.mpPlaceaCall(sut1,sut2,sut3,driver,element,2);
		   ...
		   //  m.Mute(sut1);
		    ...
		    System.out.println("Test case execution completed, writing output to file");
			   ...
			   String Info= "Call Between " + sut1 + " & " + sut2+ " & " + sut3;
